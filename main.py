...
Label(tab3, text="Введите количество градуировочных растворов", font=("Arial Bold", 10)).place(x=10, y=100)
...
def pole_n_proba():
    ...
    табличка добавления массовой доли
    """
    global name_table_mass_dol_proba # создаем глобальную переменную для названия таблички массовой доли
    name_table_mass_dol_proba = Label(tab3, text="Массовая доля (%)", font=("Arial Bold", 10))
    name_table_mass_dol_proba.place(x=10, y=140)

    gap_0 = 0 # горизонтальный пропуск для таблички массовой доли

    for e in range(num_el):

        globals()['lbl_el_m_d_proba' + str(e)] = Label(tab3, text=f'Элемент_{e + 1}', font=("Arial Bold", 8))
        globals()['lbl_el_m_d_proba' + str(e)].place(x=120+gap_0, y=160)
        ...
        for i in range(num_std):
            ...
            # создание таблички со стандартами
            if 'lbl_std_m_d_proba' + str(i) not in globals():
                globals()['lbl_std_m_d_proba' + str(i)] = Label(tab3, text=f'Стандарт_{i+1}', font=("Arial Bold", 8))
                globals()['lbl_std_m_d_proba' + str(i)].place(x=40, y=180+gap_1)

            if 'lbl_ent_m_d_proba' + str(e) + str(i) not in globals():
                globals()['lbl_ent_m_d_proba' + str(e) + str(i)] = ttk.Entry(tab3, width = 10)
                globals()['lbl_ent_m_d_proba' + str(e) + str(i)].place(x=50+gap_0, y=180+gap_1)
    ...
    for e in range(num_el):
        ...
        globals()['lbl_el_imp_proba' + str(e)] = Label(tab3, text=f'Элемент_{e + 1}', font=("Arial Bold", 8))
        ...
        for i in range(num_std):
            ...
            if 'lbl_std_imp_proba' + str(i) not in globals():
                globals()['lbl_std_imp_proba' + str(i)] = Label(tab3, text=f'Стандарт_{i + 1}', font=("Arial Bold", 8))
    ...
    for e in range(num_el):
        ...
        globals()['lbl_el_razb_proba' + str(e)] = Label(tab3, text=f'Элемент_{e + 1}', font=("Arial Bold", 8))
        ...
        for i in range(num_std):
            ...
            if 'lbl_std_razb_proba' + str(i) not in globals():
                globals()['lbl_std_razb_proba' + str(i)] = Label(tab3, text=f'Стандарт_{i+1}', font=("Arial Bold", 8))
    ...
    for e in range(num_el):
        ...
        globals()['lbl_el_rsd_proba' + str(e)] = Label(tab3, text=f'Элемент_{e + 1}', font=("Arial Bold", 8))
        ...
        for i in range(num_std):
            ...
            if 'lbl_std_rsd_proba' + str(i) not in globals():
                globals()['lbl_std_rsd_proba' + str(i)] = Label(tab3, text=f'Стандарт_{i + 1}', font=("Arial Bold", 8))
    ...
    name_table_probirka_proba = Label(tab3, text="Растворение ГСО", font=("Arial Bold", 10))
    ...
    for e in range(num_el):
        ...
        for i in range(num_std):
            ...
            if 'lbl_std_probirka_proba' + str(i) not in globals():
                globals()['lbl_std_probirka_proba' + str(i)] = Label(tab3, text=f'Стандарт_{i + 1}', font=("Arial Bold", 8))
...
def pole_n_del_proba():
    ...
    name_table_mass_dol_proba.destroy()
    ...
    tabl_del_1 = ['lbl_el_m_d_proba', 'lbl_el_razb_proba', 'lbl_el_imp_proba', 'lbl_el_rsd_proba', 'lbl_el_probirk_proba']
    ...
    for e in range(10):
        ...
        # название всех табличек
        tabl_del_2 = ['lbl_std_m_d_proba','lbl_ent_m_d_proba','lbl_std_razb_proba','lbl_ent_razb_proba',\
